...
public record Order(String orderId, String customerId, List<OrderLine> lines, PaymentMethod paymentMethod) {
    ...
    public static Result<Order, PaymentError> of(String id, String cid, List<OrderLine> lines, PaymentMethod pm) {
        if (lines == null || lines.isEmpty()) return Result.err(new PaymentError.EmptyOrder());
