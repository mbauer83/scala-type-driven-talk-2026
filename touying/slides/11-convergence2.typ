...
#theory-slide(
  ...
  beat-grid(dim_previous: true, (
    ...
    ([1969], [Curry-Howard], [Proposition = Type. Proof = Program. Running = Simplifying a proof (β-reduction IS proof reduction). Writing code that compiles = Constructing a proof.]),
...
→ Advance to Slide 13 (~15 sec dwell on Π and Σ rules), then advance to Slide 14.
]
