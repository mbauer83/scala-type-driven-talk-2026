...
// 31-the-climb, which used to carry the bookkeeping, is cut to the appendix
// for the same reason. The claim is now made once, positively, and the concept
// name lands once. The exact retired wording is in tools/retired.tsv, not
// repeated here. Gentzen required it. Curry-Howard required it." — which was
// the only lint ERROR in Act 5, and the roll-call asks the room to do
// bookkeeping at the moment it should be feeling something. See the script.
